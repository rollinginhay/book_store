...
public class CampaignDetailController {
    ...
    @Operation(summary = "Get campaign details by campaign ID")
    ...
    @Operation(summary = "Get campaign detail by ID")
    ...
    @Operation(summary = "Create new campaign detail")
    ...
    @Operation(summary = "Update campaign detail")
